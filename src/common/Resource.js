export const resourceVN = {
    ...
    ValidateError_DepartmentNameNotEmpty: 'Tên đơn vị không được để trống.',
    ValidateError_OganizationCodeNotEmpty: 'Mã dự án không được để trống.',
    ValidateError_OganizationNameNotEmpty: 'Tên dự án không được để trống.',
    ValidateError_PositionsCodeNotEmpty: 'Mã chức danh không được để trống.',
    ValidateError_PositionsNameNotEmpty: 'Tên chức danh không được để trống.',
